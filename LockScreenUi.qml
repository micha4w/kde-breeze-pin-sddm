    ...
    MouseArea {
        ...
        RowLayout {
            ...
            anchors {
                left: parent.left
                right: parent.right
                leftMargin: (lockScreenRoot.width - buttonGrid.width) / 3
                rightMargin: (lockScreenRoot.width - buttonGrid.width) / 3
            }
                ...
                GridView {
                    ...
                    delegate: Item {
                        ...
                        PlasmaComponents3.Button {
                            ...
                            enabled: mainBlock.mainPasswordBox.enabled
                            ...
                            onClicked: {
                                if (key === '⌫')
                                    mainBlock.mainPasswordBox.text = mainBlock.mainPasswordBox.text.slice(0, -1)
                                else if (key === '⏎')
                                    mainBlock.startLogin()
                                else
                                    mainBlock.mainPasswordBox.text += key
