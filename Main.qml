    ...
    MouseArea {
        ...
        RowLayout {
            ...
            anchors {
                left: parent.left
                right: parent.right
                leftMargin: (loginScreenRoot.width - buttonGrid.width) / 3
                rightMargin: (loginScreenRoot.width - buttonGrid.width) / 3
            }
            height: loginScreenRoot.height + PlasmaCore.Units.gridUnit * 3

            transform: Scale { origin.x: width*0.25; origin.y: height*0.5;  xScale: 1.25; yScale: 1.25 }
            ...
            Item {
                ...
                GridView {
                    ...
                    cellWidth: PlasmaCore.Units.gridUnit * 6
                    cellHeight: PlasmaCore.Units.gridUnit * 6
                    ...
                    model: ListModel {
                        ListElement { key:  '7' } ListElement { key: '8' } ListElement { key:  '9' }
                        ListElement { key:  '4' } ListElement { key: '5' } ListElement { key:  '6' }
                        ListElement { key:  '1' } ListElement { key: '2' } ListElement { key:  '3' }
                        ListElement { key: '⌫' } ListElement { key: '0' } ListElement { key: '⏎' }
                    }


                    delegate: Item {
                        width: buttonGrid.cellWidth; height: buttonGrid.cellHeight
                        ...
                        PlasmaComponents3.Button {
                            ...
                            background: Rectangle {
                                ...
                                opacity: control.down ? 0.25 : control.hovered ? 0.1 : 0
                            ...
                            onClicked: {
                                if (mainStack.enabled) {
                                    if (key === '⌫')
                                        userListComponent.mainPasswordBox.text = userListComponent.mainPasswordBox.text.slice(0, -1)
                                    else if (key === '⏎')
                                        userListComponent.startLogin()
                                    else
                                        userListComponent.mainPasswordBox.text += key
